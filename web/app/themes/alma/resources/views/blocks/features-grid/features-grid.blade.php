<section class="py-16 bg-zinc-50 dark:bg-zinc-900/50 {{ $attributes['align'] ?? '' }}">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">

        <div class="text-center mb-12">
            <h2 class="text-3xl font-bold tracking-tight text-zinc-900 dark:text-white sm:text-4xl">
                {{ $attributes['sectionTitle'] ?? 'Features Section' }}
            </h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div
                ...
                <div class="p-8 md:w-1/2 flex flex-col justify-center">
                    <h3 class="text-2xl font-bold text-zinc-900 dark:text-white mb-4">
                        {{ $attributes['feature1Title'] ?? 'Highlighted Feature 1' }}
                    </h3>
                    <p class="text-zinc-600 dark:text-zinc-400">
                        {{ $attributes['feature1Desc'] ?? 'Use main feature cards with supporting visuals to quickly show how your app solves real problems.' }}
                    </p>
                </div>
            ...
            <div
                ...
                <div class="p-8 flex-1">
                    <h3 class="text-xl font-bold text-zinc-900 dark:text-white mb-3">
                        {{ $attributes['feature2Title'] ?? 'Highlighted Feature 2' }}
                    </h3>
                    <p class="text-zinc-600 dark:text-zinc-400 text-sm">
                        {{ $attributes['feature2Desc'] ?? 'Brief explanation of the secondary feature.' }}
                    </p>
                </div>
            ...
            <div
                ...
                <div class="p-8 flex-1">
                    <h3 class="text-xl font-bold text-zinc-900 dark:text-white mb-3">
                        {{ $attributes['feature3Title'] ?? 'Highlighted Feature 3' }}
                    </h3>
                    <p class="text-zinc-600 dark:text-zinc-400 text-sm">
                        {{ $attributes['feature3Desc'] ?? 'Brief explanation of the tertiary feature.' }}
                    </p>
                </div>
                <div class="bg-zinc-100 dark:bg-zinc-700 h-48 flex items-center justify-center">
